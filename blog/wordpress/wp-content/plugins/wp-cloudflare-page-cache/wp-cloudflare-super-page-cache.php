        ...
        function update_plugin() {
            ...
            if( $current_version === false || version_compare( $current_version, $this->version, '!=') ) {
                ...
                if( $current_version === false ) {
                    ...
                    if( version_compare( $current_version, '4.5.9', '<' ) ) {
                        if ( count($this->objects) == 0 )
                            $this->include_libs();

                        $this->objects['logs']->add_log('swcfpc::update_plugin', 'Updating to v4.5.9');
                        ...
                        add_action('shutdown', function() {
                            ...
                            $objects['logs']->add_log('swcfpc::update_plugin', 'Update to v4.5.9 complete');
